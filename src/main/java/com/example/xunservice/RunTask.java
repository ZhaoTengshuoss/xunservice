...
public class RunTask  extends JFrame{
	...
	private void initialize() {
		...
		taskFra.getContentPane().setFont(new Font("宋体",Font.PLAIN,20));
		taskFra.getContentPane().setLayout(null);
		taskFra.setResizable(false);

		
		JLabel jLabel;
		ImageIcon icon=new ImageIcon(RunTask.class.getResource("/static/img/logo.png"));	
		icon.setImage(icon.getImage().getScaledInstance(150,80,5));
		jLabel = new JLabel((""),icon,SwingConstants.CENTER);
		jLabel.setBounds(0, 0, 150, 80);
		...
		taskFra.setFont(new Font("宋体",Font.PLAIN,20));
	}
/***查看文件属性***/
